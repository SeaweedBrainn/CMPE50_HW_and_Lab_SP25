...
public:
	...
	friend Polynomial operator+(const Polynomial &polya, double c);
	friend Polynomial operator-(const Polynomial &polya, double c);
	friend Polynomial operator*(const Polynomial &polya, double c);

	friend Polynomial operator+(double c,const Polynomial &polya);
	friend Polynomial operator-(double c,const Polynomial &polya);
	friend Polynomial operator*(double c,const Polynomial &polya);

	friend bool operator==(const Polynomial &polya, const Polynomial &polyb);
